<template>
  <div class="hello">
        ...
        <div class="accessory-result">
          ...
          <div class="filter stopPop" id="filter" v-bind:class="{'filterby-show':filterBy}">
            <dl class="filter-price">
              <dt>Price:</dt>
              <dd><a href="javascript:void(0)" v-bind:class="{'cur':priceChecked=='all'}" @click="setPriceFiter('all')">All</a></dd>
              <dd v-for="(price,index) in priceFilter" @click="setPriceFiter(index)">
          ...
          <div class="accessory-list-wrap">
            <div class="accessory-list col-4">
              ...
              <div v-infinite-scroll="loadMore" infinite-scroll-disabled="busy" infinite-scroll-distance="20" class="load-more">
                  <img v-show="loading" src="./../assets/loading-bubbles.svg"
              </div>
            </div>
          </div>
        </div>
    ...
    <modal v-bind:mdShow="mdShowCart" v-on:close="closeModal">
      <p slot="message">
        <svg class="icon-arrow-short" v-bind:class="{'sort-up':!sortFlag}"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-arrow-short"></use></svg>
        <span>加入购物车成功！</span>
      </p>
      <div slot="btnGroup">
